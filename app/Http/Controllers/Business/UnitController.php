...
class UnitController extends BusinessController
{
    ...
    public function index(){
       return view('business.unit.index');
    }
    ...
    public function create(Request $request){
       ...
       return view('business.unit.add',['trade_id'=>$trade_id]);
    }
    ...
    public function edit(Request $request,$id){
        ...
        return view('business.unit.edit',['model'=>$result,'result'=>$trade]);
    }
    ...
    private function _updateButton($id=0){
        return '<a href="' . url('business/unit/' . $id.'/edit') . '" class="btn btn-xs btn-info tooltips" data-toggle="modal" data-target="#myModal" data-original-title="修改"  data-placement="top"><i class="fa fa-edit"></i></a> ';
    }
}
