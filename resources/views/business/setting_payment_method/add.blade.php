...
<div class="modal-header">
    ...
    <h5 class="modal-title">新增银行账户</h5>
</div>
<div class="modal-body">
    <form class="form-horizontal" id="unit_from" method="post" action='{{url('business/setting_payment_method')}}'>
        {{csrf_field()}}
        <div class="hr-line-dashed"></div>
        <div class="form-group">
            <label class="col-sm-3 control-label">开户名：</label>
            <div class="col-sm-5">
                <input type="text" class="form-control" name='account_name' placeholder="开户名" required>
            </div>
        </div>
        <div class="hr-line-dashed"></div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name='account' placeholder="银行账号">
            </div>
        </div>
