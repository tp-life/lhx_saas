                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" role="form" method='post'
                              action='{{url("business/tradeattr/update")}}' id="demo_form">
                            {{csrf_field()}}
                            ...
                            <div class='tab-content'>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" required id="title"
                                               name='attribute_name'
                                               placeholder="规格属性名称" value="{{$info->title}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="i-checks">
                                            <label> <input type="checkbox" name="is_select" @if(\App\Models\Common\ClassattrModel::_TEMPLATE_ON == $info->is_select) checked @endif value="{{\App\Models\Common\ClassattrModel::_TEMPLATE_ON}}"> <i></i>&nbsp;
                                                作为默认模板 </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="alert alert-warning" role="alert"><i
                                                            class="fa fa-warning"></i> 最多可添加4个要素
                                                </div>
                                                    ...
                                                    @foreach($model as $value)
                                                        <tr class="show_row">
                                                            <td style="vertical-align:middle;min-width: 150px; "
                                                                class="col-sm-2">
                                                                <input type="text"
                                                                       name="save_attr_name[{{$value['id']}}]"
                                                                       class="input form-control" size="5"
                                                                       value="{{$value['name']}}"
                                                                       required></td>
                                                            <td>
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <div class="input-group attr_val_box">
                                                                        ...
                                                                        <div class="input-group-addon">
                                                                            <a class="btn btn-xs btn-info btn-outline"
                                                                               ...
                                                                               onclick="removeRow(this,'.show_row')"><i
                                                                    ...
                                                                    <div class="show_attr col-sm-12"
                                                                        ...
                                                                        @foreach($value['value'] as $v)
                                                                            <span class="show_label_row">
                                                                                <input
                                                                                        type="hidden"
                                                                                        name="save_attr_val[{{$value['id']}}][]"
                                                                                        value="{{$v}}">
                                                                                <button class="btn btn-primary" type="button" style="margin: 0 10px 8px 0"> {{$v}}
                                                                                    &nbsp;&nbsp;
                                                    ...
                                                    <tr>
                                                        <td colspan="2" align="left">
                                                            <button class="btn  btn-primary" type="button"
                                                                    onclick="createAttr()"><i
                                                                        class="fa fa-plus-square"></i> 添加要素
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    </tfoot>
