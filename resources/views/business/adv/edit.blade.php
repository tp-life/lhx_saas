            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method='post' action='{{url('business/adv',[$info->id])}}' id="createForm">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            <div class='tab-content' >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" require value="{{$info->adv_title}}" name='adv_title' placeholder="广告名称" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control selectpicker" name="ap_id" required {{--multiple--}}>
                                            <option value="1" @if($info->ap_id == 1) selected @endif>幻灯广告</option>
                                            <option value="2" @if($info->ap_id == 2) selected @endif>通栏广告</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group {{ $errors->has('train_time') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group" id="trainTime">
                                            ...
                                            <input type="text" class="form-control"  name="adv_time" readonly  placeholder="请选择签约时间" value="{{date('Y/m/d',$info->adv_start_date)}}-{{date('Y/m/d',$info->adv_end_date)}}"/>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"  value="{{$info->adv_sort}}" name='adv_sort' placeholder="广告优先级" required>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"  value="{{$info->adv_url}}" name='adv_url' placeholder="访问地址">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 ">
                                        ...
                                        @if(!empty($info->adv_img))
                                            <div id="picfileList" class="uploader-list" >
                                                <img src="{{ $info->adv_img }}" style="height: 100px;" class="zoomify"/>
                                                <input type="hidden" name="adv_img" value="{{ $info->adv_img }}"/>
                                            </div>
                                        @else
