...
@section('content')
    ...
    <script>
        ...
        var goodsIndex =document.referrer;
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            ...
                                            <div class="col-sm-7 more_spec hide">
                                                <select class="form-control" name="spec_id" id="spec">
                                                    ...
                                                    @foreach($spec as $val)
                                                        <option value="{{$val->id}}" @if($map ->spec_type==\App\Models\Common\GoodsModel:: _SPEC_TYPE_MORE && $val->id == $map->goods_spec['spec_id']) selected  @endif>{{$val->title}}</option>
                                                    @endforeach
