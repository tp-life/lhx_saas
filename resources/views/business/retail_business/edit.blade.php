    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong><i class="fa fa-plus"></i>修改进货商</strong>
                </li>
            </ol>
        </div>
    </div>
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form method="POST" action="{{url('business/retail_business', ['id'=>$model->id])}}" class="form-horizontal">
                    {{csrf_field()}}
                    {{method_field('PUT')}}
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="form-group {{ $errors->has('supplier.business_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="supplier[business_name]" value="{{old('supplier.business_name',$model->business_name)}}" placeholder="客户名称">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control form-filter" name="supplier[level]" style="">
                                        ...
                                        @foreach($customer_level as $key=>$value)
                                            <option value="{{ $key }}" {{  old('supplier.level',$model->level) == $key ? 'selected' : '' }}>{{$value}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group {{ $errors->has('account.account_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" disabled style="width: 50%;float: left" name="account[account_name]" value="{{old('account.account_name',$account->account_name)}}" placeholder="账号">
                                    <label style="line-height: 34px;margin-left: 20px;"><input type="checkbox" class="" name="supplier[status]" value="1" {{old('supplier.status',$model->status) == 1 ? 'checked' : ''}}>启用账号</label>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group {{ $errors->has('supplier.sale_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control form-filter" name="supplier[sale_id]" style="">
                                        <option value="" >请选择</option>
                                        @foreach($customer_level as $key=>$value)
                                            <option value="{{ $key }}" {{  old('supplier.sale_id', $model->sale_id) == $key ? 'selected' : '' }}>{{$value}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control form-filter" name="supplier[sale_region]" style="">
                                        ...
                                        @foreach($sale_region as $value)
                                            <option value="{{ $value['id'] }}" {{  old('supplier.sale_region', $model->sale_region) == $value['id'] ? 'selected' : '' }}>{{$value['name']}}</option>
                                            @if(isset($value['child']))
                                                @foreach($value['child'] as $key1=>$child_value)
                                                    <option value="{{ $child_value['id'] }}" {{  old('supplier.sale_region', $model->sale_region) == $child_value['id'] ? 'selected' : '' }}>&emsp;&emsp;{{$child_value['name']}}</option>
                                                @endforeach
                                            @endif
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group {{ $errors->has('supplier.train_time') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group" id="trainTime">
                                        ...
                                        <input type="text" class="form-control"  name="supplier[train_time]" id="input_train_time" readonly  placeholder="请选择签约时间" value="{{old('supplier.train_time',date('Y/m/d', $model->start_time).'-'.date('Y/m/d', $model->end_time))}}"/>
                                    </div>
                            ...
                            <div class="form-group {{ $errors->has('supplier.name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="supplier[name]" value="{{old('supplier.name', $model->name)}}" placeholder="姓名">
                            ...
                            <div class="form-group {{ $errors->has('supplier.job') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="supplier[job]" value="{{old('supplier.job', $model->job)}}" placeholder="职位">
                            ...
                            <div class="form-group {{ $errors->has('supplier.phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="supplier[phone]" value="{{old('supplier.phone', $model->phone)}}" placeholder="手机">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group {{ ($errors->has('p_id') || $errors->has('c_id') || $errors->has('a_id') || $errors->has('pca')) ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @if ($errors->has('p_id') || $errors->has('c_id') || $errors->has('a_id') || $errors->has('pca'))
                            ...
                            <div class="form-group {{ $errors->has('supplier.address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="supplier[address]" value="{{old('supplier.address', $model->address)}}" placeholder="详细地址">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="form-group {{ $errors->has('supplier.bank_user') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="supplier[bank_user]" value="{{old('supplier.bank_user', $model->bank_user)}}" placeholder="开户名称">
                            ...
                            <div class="form-group {{ $errors->has('supplier.bank_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="supplier[bank_name]" value="{{old('supplier.bank_name', $model->bank_name)}}" placeholder="开户银行">
                            ...
                            <div class="form-group {{ $errors->has('supplier.bank_card') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="supplier[bank_card]" value="{{old('supplier.bank_card', $model->bank_card)}}" placeholder="银行卡号">
                            ...
                            <div class="form-group {{ $errors->has('supplier.invoice_header') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="supplier[invoice_header]" value="{{old('supplier.invoice_header', $model->invoice_header)}}" placeholder="发票抬头">
