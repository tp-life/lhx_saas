...
<div class="animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" id="addForm" action="{{ url('business/order/update_note') }}" class="form-horizontal">
                {{csrf_field()}}
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="form-group">
                            <div class="col-sm-10">
                                <textarea class="form-control" name="note" rows="5" style="width: 558px;">{{$order->order_note}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
