<div class="modal-header">
    ...
    <h4 class="modal-title">新增销售区域</h4>
</div>
<div class="animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <form method="POST" id="addForm" action="{{ url('business/business_customer_region') }}" class="form-horizontal">
                {{csrf_field()}}
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" value="" placeholder="级别名称">
                            </div>
                        </div>
        ...
        $.ajax({
            ...
            success:function (response) {
                ...
                if (response.status == 1) {
                    ...
                    layer.msg(response.msg ? response.msg : '添加失败', function(){});
                }
            },
