            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" role="form" method='post' action='{{url("business/brand/store")}}' id="demo_form">
                            {{csrf_field()}}
                            <div class='tab-content' >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="hidden" name="class_ids[]" value="{{getBusinessTradeId()}}">
                                    </div>
                                </div>
