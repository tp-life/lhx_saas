            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" role="form" method='post' action='{{url("business/brand/update")}}' id="demo_form">
                            {{csrf_field()}}
                            ...
                            <div class='tab-content' style='margin-top:20px;'>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a href="{{url('business/brand/index')}}" class="btn btn-info">返回列表</a>
                                    </div>
                                </div>
    ...
    <script>
        $(function(){
            ...
            WebUploader.create({
                ...
                server: '{{url("business/brand/upload")}}',
                pick: '#pic',
            ...
            $("#demo_form").submit(function(){
                $(this).ajaxSubmit({success:function(e) {
                    if(e.status == 1){
                        ...
                        setTimeout(function(){
                            window.location.href='{{url('business/brand/index')}}';
                        },1500);
                    }else{
