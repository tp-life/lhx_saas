...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="{{url('business/dash')}}">{!!trans('admin/breadcrumb.home')!!}</a>
                </li>
                <li class="active">
        ...
        <div class="col-lg-2">
            <div class="title-action">
                <a href="{{url('business/unit/create')}}" data-toggle="modal" data-target="#myModal" class="btn btn-info">添加商品单位</a>
            </div>
        </div>
        @endpermission
    </div>
...
@section('js')
    ...
    <script src="{{asset('business/js/unit/unit-datatable.js')}}"></script>
    <script type="text/javascript">
        ...
        function deleted(id) {
            layer.confirm('{{trans('admin/alert.deleteTitle')}}', {
                ...
                $.post('{{url('business/unit/destroy')}}',{
                    '_token':'{{csrf_token()}}',
                    id:id
                },function (data) {
                    layer.close(index);
