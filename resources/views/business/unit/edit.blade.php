...
<div class="modal-body">
    <form class="form-horizontal" id="unit_from" method="post" action='{{url("business/unit/update")}}'>
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                ...
                <input type="hidden" name="class_ids[]" value="{{$model->class_ids}}">
            </div>
        ...
        $("#unit_from").submit(function(){
            $(this).ajaxSubmit({success:function(e) {
                if(e.status == 1){
                    ...
                    setTimeout(function(){
                        window.location.href='{{url('business/unit/index')}}';
                    },1500);
                }else{
