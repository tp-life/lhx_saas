                        ...
                        <form class="form-horizontal" method='post' action='{{url("admin/article")}}' id="createForm">
                            ...
                            <div class='tab-content' >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="article_title" name='article_title' value="{{$info->article_title}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="ac_id" class="form-control" name="ac_id" disabled>
                                                ...
                                                @foreach($article_class_list as $val)
                                                    ...
                                                    @if(isset($val['child']))
                                                        @foreach($val['child'] as $vo)
                                                            <option value="{{$vo['id']}}" @if($info->ac_id == $vo['id'])  selected = "selected" @endif>&emsp;{{$vo['ac_name']}}</option>
                                                        @endforeach
                                                    @endif
                                                @endforeach
                                            @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="article_url" name='article_url' value="{{$info->article_url}}" disabled>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"  id="article_sort" name='article_sort' value="{{$info->article_sort}}" disabled>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 ">
                                        <label class="radio-inline">
                                            <input type="radio" name="article_show" @if($info->article_show == 1) checked @endif  value="1" disabled> 是
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="article_show" @if($info->article_show == 0) checked @endif value="0" disabled> 否
                                        </label>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea  id="article_content" name="article_content" style="height: 240px;" disabled>{{$info->article_content}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
