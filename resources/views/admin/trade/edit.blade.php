            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" role="form" method='post' action='{{url("admin/trade/update")}}'
                              id="demo_form">
                            {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" required id="title" name='name'
                                               value="{{$model->name}}" placeholder="行业名称">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="class" name='class'
                                               value="{{$model->class}}" placeholder="行业类样式">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="tag" name='tags'
                                               value="{{$model->tags}}" placeholder="行业标签">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 ">
                                        <label class="radio-inline">
                                            <input type="radio" name="status" @if($model->status == 1) checked
                                                   @endif value="1"> 启用
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="status" @if($model->status == 2) checked
                                                   @endif  value="2"> 禁用
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="status" @if($model->status == 3) checked
                                                   @endif  value="3"> 违规
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 ">
                                        ...
                                        <div id="picfileList" class="uploader-list">
                                            @if($model->pic)
                                                <span>
                                                    <img src="{{$model->pic}}" style="height: 80px;"/>
