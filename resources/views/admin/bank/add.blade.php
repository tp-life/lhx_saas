            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method='post' action='{{url("admin/bank")}}' id="createForm">
                            {{csrf_field()}}
                            <div class='tab-content' >
                                <div class="form-group">
                                    <label for="brand_name" class="col-sm-2 control-label">银行名字</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" require id="bank_name" name='bank_name' placeholder="银行名字" required>
                                    </div>
                                </div>
