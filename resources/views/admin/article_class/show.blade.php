                        ...
                        <form class="form-horizontal" method='post' action='{{url("admin/article_class")}}' id="createForm">
                            ...
                            <div class='tab-content' >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="{{$info->ac_name}}" id="ac_name" name='ac_name' placeholder="分类名称" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="ac_parent_id" class="form-control" name="ac_parent_id" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"  id="ac_sort" name='ac_sort' value="{{$info->ac_sort}}" placeholder="排序" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
