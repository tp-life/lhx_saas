    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
            <div class="title-action">
                <a href="{{url('admin/article_class/create')}}" class="btn btn-info">添加分类</a>
            </div>
        </div>
        @endpermission
    </div>
...
@section('js')
    ...
    <script src="{{asset('admin/js/article_class/article_class.js')}}"></script>
    <script type="text/javascript">
        ...
        function deleted(id) {
            layer.confirm('{{trans('admin/alert.deleteTitle')}}', {
                ...
                $.post('{{url('admin/article_class/destroy')}}',{
                    '_token':'{{csrf_token()}}',
                    id:id
                },function (data) {
                    layer.close(index);
