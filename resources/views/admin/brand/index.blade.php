    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
            <div class="title-action">
                <a href="{{url('admin/brand/create')}}" class="btn btn-info">添加品牌</a>
            </div>
        </div>
        @endpermission
    </div>
...
@section('js')
    ...
    <script src="{{asset('admin/js/brand/brand-datatable.js')}}"></script>
