            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" role="form" method='post' action='{{url("admin/brand/update")}}' id="demo_form">
                            {{csrf_field()}}
                            ...
                            <div class='tab-content' style='margin-top:20px;'>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" required id="brand_name" name='brand_name' value="{{$info->brand_name}}" placeholder="品牌名称">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select id="class_ids" class="form-control selectpicker" name="class_ids[]" required multiple>
                                            @foreach($class as $val)
                                                <option value="{{$val->id}}" @if( in_array($val->id,explode(',',$info->class_ids))) selected @endif>{{$val->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"  required id="brand_en_name" name='brand_en_name' value="{{$info->brand_en_name}}" placeholder="英文名称">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"  id="site" name='site' placeholder="site" value="{{$info->site}}">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 ">
                                        <label class="radio-inline">
                                            <input type="radio" name="status"  @if($info->status == 1) checked @endif value="1" > 启用
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="status"  @if($info->status == 2) checked @endif  value="2"> 禁用
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="status"  @if($info->status == 3) checked @endif  value="3"> 违规
                                        </label>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 ">
                                        ...
                                        <div id="picfileList" class="uploader-list">
                                            @if($info->logo)
                                                <span>
                                <img src="{{$info->logo}}" style="height: 80px;"/>
