    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form method="POST" action="{{url('admin/retail_business')}}" class="form-horizontal">
                    {{csrf_field()}}
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="form-group {{ $errors->has('business_info.business_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="business_info[business_name]" value="{{old('business_info.business_name')}}" placeholder="客户名称">
                            ...
                            <div class="form-group {{ $errors->has('account.account_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <label style="line-height: 34px;margin-left: 20px;"><input type="checkbox" class="" name="account[status]" value="1" {{old('account.status') == 1 ? 'checked' : ''}}>启用账号</label>
                            ...
                            <div class="form-group {{ $errors->has('business_info.train_time') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group" id="trainTime">
                                        ...
                                        <input type="text" class="form-control"  name="business_info[train_time]" id="input_train_time" readonly  placeholder="请选择签约时间" value="{{old('business_info.train_time')}}"/>
                                    </div>
                            ...
                            <div class="form-group {{ $errors->has('business_info.contact_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="business_info[contact_name]" value="{{old('business_info.contact_name')}}" placeholder="姓名">
                            ...
                            <div class="form-group {{ $errors->has('business_info.contact_job') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="business_info[contact_job]" value="{{old('business_info.contact_job')}}" placeholder="职位">
                            ...
                            <div class="form-group {{ $errors->has('business_info.contact_mobile') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="business_info[contact_mobile]" value="{{old('business_info.contact_mobile')}}" placeholder="手机">
                            ...
                            <div class="form-group {{ $errors->has('business_info.address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="business_info[address]" value="{{old('business_info.address')}}" placeholder="详细地址">
