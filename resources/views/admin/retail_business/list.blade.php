  ...
  <div class="col-lg-10">
    ...
    <div class="col-lg-2">
        <div class="title-action">
            <a href="{{url('admin/retail_business/create')}}" class="btn btn-info">添加进货商</a>
        </div>
    </div>
    @endpermission
</div>
...
@section('js')
    <script>
        var businessLists =  "<option value='0'>所属供货商</option>"+@foreach($businessLists as $key=>$item)
...
<script src="{{asset('admin/js/retail_business/retail_business-datatable.js')}}"></script>
