...
<div class="ibox float-e-margins animated bounceIn formBox" id="editBox">
    ...
    <div class="ibox-content">
        <form method="post" action="{{url('admin/goods_category',[$goods_category_info->id])}}" class="form-horizontal" id="editForm" onsubmit="return false">
            {!!csrf_field()!!}
            {{method_field('PUT')}}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="{{trans('admin/goods.model.class_name')}}" name="class_name" value="{{$goods_category_info->class_name}}">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-4 col-sm-offset-2">
                    ...
                    <button class="btn btn-primary editButton ladda-button"
