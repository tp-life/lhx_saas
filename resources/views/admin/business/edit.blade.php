    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong><i class="fa fa-pencil"></i>修改批发商</strong>
                </li>
            </ol>
        </div>
    </div>
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form method="POST" action="{{url('admin/business',['id'=>$model->id])}}" class="form-horizontal">
                    {{csrf_field()}}
                    {{method_field('PUT')}}
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="form-group {{ $errors->has('business_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="business_name" value="{{old('business_name', $model->business_name)}}" placeholder="商户名称">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control form-filter" name="class_id" style="">
                                        @foreach($classLists as $value)
                                            <option {{$value->id == old('class_id', $model->class_id) ? 'checked' : ''}} value="{{$value->id}}">{{$value->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group {{ $errors->has('contact_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="contact_name" value="{{old('contact_name', $model->contact_name)}}" placeholder="姓名">
                            ...
                            <div class="form-group {{ $errors->has('contact_job') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="contact_job" value="{{old('contact_job', $model->contact_job)}}" placeholder="职位">
                            ...
                            <div class="form-group {{ $errors->has('contact_mobile') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="contact_mobile" value="{{old('contact_mobile',$model->contact_mobile)}}" placeholder="手机">
                            ...
                            <div class="form-group {{ $errors->has('train_time') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group" id="trainTime">
                                        ...
                                        <input type="text" class="form-control"  name="train_time" readonly  placeholder="请选择签约时间" value="{{old('train_time', date('Y/m/d', $model->start_time).'-'.date('Y/m/d', $model->end_time))}}"/>
                                    </div>
                            ...
                            <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="address" value="{{old('address', $model->address)}}" placeholder="详细地址">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" disabled class="form-control" name="account" value="{{old('account', $account->account_name)}}" placeholder="账号">
                                    <span class="help-block m-b-none text-primary">登录主账号由8--12位字母或数字组成</span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group{{ $errors->has('open') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="checkbox" class="" name="account_open" value="1" {{old('account_open', $account->status) == 1 ? 'checked' : ''}}>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="form-group {{ $errors->has('bank_user') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="bank_user" value="{{old('bank_user', $model->bank_user)}}" placeholder="开户名称">
                            ...
                            <div class="form-group {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="bank_name" value="{{old('bank_name', $model->bank_name)}}" placeholder="开户银行">
                            ...
                            <div class="form-group {{ $errors->has('bank_card') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="bank_card" value="{{old('bank_card', $model->bank_card)}}" placeholder="银行卡号">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <a class="btn btn-white" href="{{url('admin/business')}}">{!!trans('admin/action.actionButton.cancel')!!}</a>
