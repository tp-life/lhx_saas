...
<head>
  ...
  <link href="{{asset('vendors/bootstrap-toastr/toastr.css')}}" rel="stylesheet">
    {{--  可放大图片 --}}
    <link href="{{asset('vendors/zoomify/zoomify.min.css')}}" rel="stylesheet">
    @yield('css')
  @yield('upload_css')
...
<body class="">
  <div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
      ...
      <div class="footer">
          ...
          <div>
              <strong>Copyright</strong> 后台 &copy;
          </div>
      </div>
  ...
  <script src="{{asset('vendors/bootstrap-toastr/toastr.min.js')}}"></script>
  {{--  可放大图片 --}}
  <script type="text/javascript" src="{{asset('vendors/zoomify/zoomify.min.js')}}"></script>
  @yield('js')
  @yield('city_js')
  @yield('upload_js')
<script>
    ...
    function showToastrReload(typeFun, message, url) {
        showToastr(typeFun, message);
        if (url) {
            setTimeout(function () {
